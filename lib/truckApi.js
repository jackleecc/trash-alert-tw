...
export const TAOYUAN_TRUCK_API_URL =
  ...
  'https://route.tyoem.gov.tw/api/trucks';

// 臺南市環保局即時動態 API（支援環境變數自訂）
export const TAINAN_TRUCK_API_URL =
  process.env.TAINAN_TRUCK_API_URL ||
  'https://soa.tainan.gov.tw/Api/Service/Get/2c8a70d5-06f2-4353-9e92-c40d33bcd969';
...
const FETCH_TIMEOUT_MS = 6000; // 6 秒逾時（避免外部 API 卡住導致 Vercel 30 秒中斷）
const MAX_RETRY_COUNT = 3;
const SINGLE_FETCH_RETRIES = 1; // 單一 URL 重試 1 次（兼顧容錯與 30s 總執行時間防線）
